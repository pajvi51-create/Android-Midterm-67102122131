...
5. `MIDTERM_REPORT_TH.md` — รายงานและบทพูดสำหรับพรีเซนต์ (อยู่ที่ root ของ Repository)

## ค่าที่ใช้สาธิต

- แผนที่: Latitude `17.1899`, Longitude `104.0914`
- ค่างวด: ราคา `12000` บาท, ดอกเบี้ย `1%` ต่อเดือน, `12` เดือน
- ผลที่ควรได้: ค่างวด `1,120.00` บาท, ยอดรวม `13,440.00` บาท, ดอกเบี้ย `1,440.00` บาท
...
- [ ] เตรียม Android Studio และ Emulator ไว้สำหรับพรีเซนต์วันอาทิตย์
